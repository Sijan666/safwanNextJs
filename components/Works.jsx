    ...
    return (
        ...
        <div className={`${className} group `}>
            <div className="lg:h-105 h-50 lg:w-142.5 bg-[#C4C4C4] hover:bg-secondarys/60 duration-300">
                <button className='p-6.25 bg-white text-primarys rounded-full mt-5 lg:ml-120 ml-20 opacity-0 group-hover:opacity-100 duration-300 cursor-pointer'><FaArrowRight size={20}/></button>
            </div>
